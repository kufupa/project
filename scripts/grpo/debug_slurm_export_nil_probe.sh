#!/usr/bin/env bash
# Appends one NDJSON line to agent debug log (session 519321). Run on submit host.
# region agent log
set -euo pipefail
LOG="/vol/bitbucket/aa6622/.logs/debug-519321.log"
T0=$(date +%s%N)
...
python3 - <<PY
import json, os, time
log_path = "/vol/bitbucket/aa6622/.logs/debug-519321.log"
row = {
    "sessionId": "519321",
